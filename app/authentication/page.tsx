                ...
                <div className="relative hidden lg:flex h-full flex-col bg-muted p-10 text-white dark:border-r">
                    ...
                    <div className="relative z-20 mt-auto">
                        <blockquote className="space-y-2">
                            <p className="text-lg">
                                &ldquo;Unveil new patterns in your patients data, save lives and push research forward in few simple clicks.&rdquo;
                            </p>
                            <footer className="text-sm">Gabriele Salvo</footer>
                        </blockquote>
                    </div>
                </div>
